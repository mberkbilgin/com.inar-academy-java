...
public class Exercise06_15 {
    public static void main(String[] args) {
        String str1 = "Taxable Income";
        String str2 = "Single";
        String str3 = "Married Joint";
        String str4 = "Married Separate";
        String str5 = "Head of house";
        System.out.printf("%-20s%-12s%-4s%21s%16s\n", str1, str2, str3, str4, str5);
        for (int i = 50000; i <= 60000; i += 50) {
            System.out.printf("%-7d%13s%-6d%6s%-13d%6s%-8d%10s%-7d", i, " ", computeTax(0, i), " ", computeTax(1, i), " ", computeTax(2, i), " ", computeTax(3, i));
            System.out.println();
        }
